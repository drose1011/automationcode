...
itemName = WebUI.getText(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_item8name')) //Get the item's name

int setItemAmount = 4 //Set up item amount to be processed later

int totalItemAmt = setItemAmount	//Add all the items

String selectedItems = '(' + totalItemAmt + ')'

WebUI.selectOptionByValue(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_selectitem8amount'), 
    '4', true) //Select item as 5

WebUI.verifyElementClickable(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_additem8tocart'))	//Verify if the Add to cart is clickable

WebUI.click(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_additem8tocart'))	//Click the Add to cart button
...
itemExpectedPriceTrim = webExpectedPrice.replace(",", "")

double itemExpectedPrice = Double.parseDouble(itemExpectedPriceTrim)
