...
itemName = WebUI.getText(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_item3name')) //Get the item's name
...
WebUI.selectOptionByValue(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_selectitem3amount'), 
    '10', true) //Select item as 5

WebUI.verifyElementClickable(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_additem3tocart'))	//Verify if the Add to cart is clickable

WebUI.click(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_additem3tocart'))	//Click the Add to cart button
