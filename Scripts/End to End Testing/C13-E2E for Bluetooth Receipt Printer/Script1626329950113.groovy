...
itemName = WebUI.getText(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_item13name')) //Get the item's name
...
WebUI.selectOptionByValue(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_selectitem13amount'), 
    '10', true) //Select item as 5

WebUI.verifyElementClickable(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_additem13tocart'))	//Verify if the Add to cart is clickable

WebUI.click(findTestObject('Single Item/Page_Shopify Hardware Rentals fulfilled by Fello/home_additem13tocart'))	//Click the Add to cart button
